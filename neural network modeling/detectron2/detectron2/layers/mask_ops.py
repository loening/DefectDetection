...
def paste_masks_in_image(
    ...
    for inds in chunks:
        ...
        # with open("/media/ps/data/train/LQ/LQ/bdmask4/workspace/mask_data/pdata/mask_pred.data", 'wb') as f_mask_pred:
            # f_mask_pred.write(masks_chunk.cpu().data.numpy().tobytes())
        ...
        # import cv2
        # cv2.imwrite("1.jpg",(masks_chunk.squeeze().cpu().numpy()*255))
