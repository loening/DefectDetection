...
class ROIAlign(nn.Module):
    ...
    def forward(self, input, rois):
        ...
        # with open("/media/ps/data/train/LQ/LQ/bdmask4/workspace/mask_data/pdata/boxes.data", 'wb') as f:
        #     print("box信息:", rois)
        #     f.write(rois.cpu().data.numpy().tobytes())
        # with open("/media/ps/data/train/LQ/LQ/bdmask4/workspace/mask_data/pdata/bases.data", 'wb') as f_input:
        #     f_input.write(input.cpu().data.numpy().tobytes())
        # torch.save(rois, r"/media/ps/data/train/LQ/LQ/blendmask/workspace/boxes.data")
        return roi_align(
            input,
