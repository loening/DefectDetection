...
jf = '/home/ps/LB/train/annotations/train.json'
imgs = '/home/ps/LB/train/train'
...
# cfg.SOLVER.MAX_ITER = 10000    # 300 iterations seems good enough, but you can certainly train longer
    ...
    cfg.OUTPUT_DIR = '/home/ps/LB/train/weights'
    cfg.SOLVER.IMS_PER_BATCH = 2
    ITERS_IN_ONE_EPOCH = int(33 / cfg.SOLVER.IMS_PER_BATCH)
