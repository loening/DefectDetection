...
class BlendMask(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.to(self.device)
        self.test_float16 = cfg.MODEL.TEST_FLOAT16
    ...
    def forward(self, batched_inputs):
        ...
        if self.test_float16:
            images = [self.normalizer(x).half() for x in images]
        else:
        ...
        # path = '/media/ps/1616B1B516B19669/LB/inf/val/features'
        # if not os.path.exists(path):
        #     os.makedirs(path)
        # f = FeatureVisualization(features,path)
        # f.get_feature()
        ...
        # base = basis_out['bases'][0].reshape(1, -1)

        ## add
        # a = basis_out['bases'][0]
        # f = FeatureVisualization(a,path)
        # f.draw_feature(a,'ng')
