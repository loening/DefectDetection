...
_C.INPUT.Aug_Pro = 0.5
_C.INPUT.HFLIP_TRAIN = False
_C.INPUT.CROP.CROP_INSTANCE = True
_C.INPUT.Brightness = []
_C.INPUT.HorFlip = False
_C.INPUT.VerFlip = False
_C.INPUT.Rotation = []
_C.INPUT.Gauss = []
_C.INPUT.Resize = True
_C.INPUT.Contrast = []
_C.INPUT.Mosaic = False
_C.INPUT.MosaicSize = 1024
_C.INPUT.MosaicPresent = 0.5
_C.INPUT.Mosaic_CenterRange = 0.5
...
# Additional parameters of tower
_C.MODEL.FCOS.P2_NUM_CLS_CONVS = 0
_C.MODEL.FCOS.P2_NUM_BOX_CONVS = 0

# Additional parameters of targets for locations
_C.MODEL.FCOS.ONE_CLASS = False
_C.MODEL.FCOS.USE_COMPRESSION = False
_C.MODEL.FCOS.CMPRS_WIDTH = 32
_C.MODEL.FCOS.CMPRS_ASPECT_RATIO = 0.25
